      ...
      <div className="absolute top-0 left-0 bg-[#DEF3C3] w-[300px] py-7 px-5  min-h-screen">
        ...
        <div className="mt-3">
          <div className="flex flex-wrap gap-3">
            {ingredients.map((ingredient) => (
              <button
                key={ingredient}
                className="bg-white border border-gray-400 rounded-md py-1 px-8 text-sm"
              >
                {upperCaseIngredient(ingredient)}
              </button>
            ))}
          </div>
        ...
        <div className="mt-9">
          ...
          <div className="flex flex-wrap gap-3 mt-3">
            <button className="bg-white border border-gray-400 rounded-md py-1 px-8 text-sm">
              Pasta
            </button>
            <button className="bg-white border border-gray-400 rounded-md py-1 px-8 text-sm">
              Tomato
