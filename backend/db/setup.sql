...
CREATE TABLE "user"(
"id" INTEGER PRIMARY KEY GENERATED ALWAYS AS (MINVALUE 0),
...
CREATE TABLE "all_plants"(
    "id" INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY (MINVALUE 0),
...
CREATE TABLE "planted_veg"(
    "id" INTEGER NOT NULL PRIMARY KEY GENERATED ALWAYS AS IDENTITY (MINVALUE 0),
    "user" INTEGER NOT NULL REFERENCES user,
